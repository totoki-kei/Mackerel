...
(最終更新日: 2014/02/16 ServerApi = 1.15)
...
banexコマンドは、banパーミッションを持つユーザから見えるようになりますが
現在、サーバプログラムのコンソールからのみ実行できます。
(ページャ作るのめんどい)
...
2014/02/16
	Terrari 1.2.3 / TShockAPI 1.15 対応
	addコマンドによるエントリ追加時、<function>が有効な判定方法でない場合は
	エラーとするように修正。
